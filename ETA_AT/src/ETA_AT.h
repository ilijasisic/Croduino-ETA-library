...
//GENERAL INFO/////////////////////////////////////////////////
// ============================================================
void ETA_AT::infoGeneral()
{
  delay(1000);
  Serial.println("GENERAL INFORMATION OF A6-GSM-MODULE: ");
  GSM.println("AT+GSN");// TA serial number identification
  updateSerial();
  GSM.println("AT+GMM");// TA model identification
  updateSerial();
  GSM.println("AT+GMR");// Revision identification
  updateSerial();
  GSM.println("AT+GMI");//TA manufacturer identification
  updateSerial();
  GSM.println("AT+CIMI");//International mobile subscriber identity
  updateSerial();
}
